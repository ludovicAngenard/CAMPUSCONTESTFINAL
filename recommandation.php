...
<footer>
        <div id='bas'>
            ...
            <ul>
                ...
                <li>
                    <a href='https://www.linkedin.com/in/ludovic-angenard-37743719a/'><img src='imageSite/Linkedin.png' alt='linkedin' id="réseausoc"></a>
                </li>
                <img src='imageSite/Campus_academy.png ' target="_blank" alt='logo_campus'id="logoc">
            </div>
            </ul>
        </div>
